      ...
      <div className="qualification__container container">
        ...
        <div className="qualification__sections">
          ...
          >
            <div className="qualification__data">
              <div>
                <h3 className="qualification__title">Executive Member</h3>
                <span className="qualification__subtitle">
            ...
            <div className="qualification__data">
              ...
              <div>
                <h3 className="qualification__title">CP Team Member</h3>
                <span className="qualification__subtitle">
                  Google Developer Student Club
                </span>
                <div className="qualification__calender">
                  <i class="uil uil-calender"></i> 2022 - present
                </div>
              </div>
            </div>
            ...
            <div className="qualification__data">
              <div>
                <h3 className="qualification__title">Maintainer</h3>
                <span className="qualification__subtitle">Hacktoberfest</span>
                <div className="qualification__calender">
                  <i class="uil uil-calender"></i> Oct-2022
                </div>
              </div>
